 ...
 * @author 18364
 */
@WebServlet("/CheckNotServlet")
public class CheckNotServlet extends HttpServlet {
    @Override
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RelationDao applyN = new RelationDao();
        ...
        //删除一条
        {
            ...
            System.out.println("团队审核界面" + applyN.deleteRelationBySid(sid));
        ...
        //删除多条
            ...
            for (String s : temp) {
                applyN.deleteRelationBySid(s);
            }
        }

        HttpSession s = request.getSession();
        StudentCalss stc = (StudentCalss) s.getAttribute("userInfo");
        RelationClass rc = applyN.findRelationBySid(stc.getSid());
        ...
        out.print("<script>alert('审核不通过，撤销申请！！！'); window.location='/CheckTeamApplyServlet' </script>");
        out.flush();
        out.close();
