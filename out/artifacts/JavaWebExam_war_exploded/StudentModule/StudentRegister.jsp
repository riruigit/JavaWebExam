...
<br><br>
<h1 align="center">学生注册显示页面</h1><br><br><br><br>
<form action="/StudentRegisterServlet">
    <table border="1" align="center" class="altrowstable" id="alternatecolor" width="500" height="200">

        <tr>
            <th>学生学号</th>
            <td><input autocomplete="off" placeholder="请输入学号" required="required" type="text" name="sid" value="">
            </td>
        </tr>

        <tr>
            <th>学生姓名</th>
            <td><input autocomplete="off" placeholder="请输入姓名" type="text" name="sname" value="" required="required">
            </td>
        </tr>
        <tr>
            <th>学生年龄</th>
            <td><input autocomplete="off" placeholder="请输入年龄" type="text" name="age" value="" required="required">
            </td>
        </tr>
        ...
        <tr>
            <th>学生密码</th>
            <td><input autocomplete="off" placeholder="请输入密码" type="password" name="password" value=""
                       required="required">
            </td>
        </tr>
        <tr>
